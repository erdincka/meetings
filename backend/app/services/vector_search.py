...
async def semantic_search(
    ...
    if "agent" in library_scopes and owner_agent_id:
        filters.append(
            and_(Document.library_scope == "agent", Document.owner_agent_id == owner_agent_id)
        )

    if "meeting" in library_scopes and meeting_id:
        filters.append(and_(Document.library_scope == "meeting", Document.meeting_id == meeting_id))
